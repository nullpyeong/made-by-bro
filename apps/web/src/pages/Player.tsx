...
/* 강의실(player) — 밝은 셸 + 다크 영상 프레임.
   ...
   ?lesson=id 로 본문(8탭 학습 워크스페이스)·재생목록·상단바를 데이터 기반으로 렌더한다. */
...
const STYLE = `
  ...
  .pl .it{padding:12px 16px;font-size:12.5px;border-bottom:1px solid var(--color-border);display:flex;align-items:center;gap:9px;cursor:pointer;text-decoration:none;color:inherit}
